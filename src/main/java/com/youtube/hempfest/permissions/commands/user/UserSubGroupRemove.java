    ...
    public boolean execute(CommandSender commandSender, String commandLabel, String[] args) {
        ...
        if (!(commandSender instanceof Player)) {
            ...
            if (length == 3) {
                ...
                System.out.println(String.format("[%s] - Removed sub-group inheritance " + '"' + groupName + '"' + " from player " + '"' + playerName + '"' + " inheritance list in world " + '"' + worldName + '"', MyPermissions.getInstance().getDescription().getName()));
        ...
        if (length == 3) {
            ...
            System.out.printf("[%s] - Removed sub-group inheritance " + '"' + groupName + '"' + " from player " + '"' + playerName + '"' + " inheritance list in world " + '"' + worldName + "\"%n", MyPermissions.getInstance().getDescription().getName());
            return true;
        }
