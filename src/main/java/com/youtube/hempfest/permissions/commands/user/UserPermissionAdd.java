...
public class UserPermissionAdd extends BukkitCommand {
    ...
    public UserPermissionAdd(String name, String description, String permission, String usageMessage, ArrayList<String> aliases) {
    ...
    public boolean execute(CommandSender commandSender, String commandLabel, String[] args) {
        ...
        if (!(commandSender instanceof Player)) {
            ...
            if (length == 3) {
                ...
                if (permList.contains(permission)) {
                    sendMessage(commandSender, um.prefix + "&c&oPlayer " + '"' + playerName + '"' + " already has direct access to permission " + '"' + permission + '"' + " in world " + '"' + worldName + '"');
                    return true;
                }
                ...
                listener.playerGive(player, worldName, permission);
                sendMessage(commandSender, um.prefix + "&a&oYou just gave permission &f" + permission + " &a&oto player &f" + '"' + playerName + '"' + " &a&oin world &f" + '"' + worldName + '"');
                return true;
            }
            ...
            if (length == 4) {
                ...
                for (String result : results) {
                    if (permList.contains(result)) {
                        sendMessage(commandSender, um.prefix + "&c&oPlayer " + '"' + playerName + '"' + " already has direct access to permission " + '"' + result + '"' + " in world " + '"' + worldName + '"');
                        return true;
                    }
                }
                List<String> worlds = Arrays.asList(um.getWorlds());
                ...
                OfflinePlayer player = Bukkit.getOfflinePlayer(um.usernameToUUID(playerName));
                listener.playerGive(player, worldName, perms);
                sendMessage(commandSender, um.prefix + "&d&oYou just gave permissions &f" + perms.toString() + " &d&oto player &f" + '"' + playerName + '"' + " &d&oin world &f" + '"' + worldName + '"');
                return true;
            }
            ...
            if (length == 5) {
                ...
                for (String result : results) {
                    if (permList.contains(result)) {
                        sendMessage(commandSender, um.prefix + "&c&oGroup " + '"' + playerName + '"' + " already has direct access to permission " + '"' + result + '"' + " in world " + '"' + worldName + '"');
                        return true;
                    }
                }
                List<String> worlds = Arrays.asList(um.getWorlds());
                ...
                OfflinePlayer player = Bukkit.getOfflinePlayer(um.usernameToUUID(playerName));
                listener.playerGive(player, worldName, perms);
                sendMessage(commandSender, um.prefix + "&d&oYou just gave permissions &f" + perms.toString() + " &d&oto group &f" + '"' + playerName + '"' + " &d&oin world &f" + '"' + worldName + '"');
                return true;
            }
            return true;
        }
        ...
        if (length == 3) {
            ...
            if (!worlds.contains(worldName)) {
                ...
                OfflinePlayer player = Bukkit.getOfflinePlayer(um.usernameToUUID(playerName));
                listener.playerGive(player, worldName, permission);
                sendMessage(p, um.prefix + "&a&oYou just gave permission &f" + permission + " &a&oto player &f" + '"' + playerName + '"' + " &a&oin world &f" + '"' + worldName + '"');
                return true;
        }
        ...
        if (length == 4) {
            ...
            for (String result : results) {
                if (permList.contains(result)) {
                    sendMessage(p, um.prefix + "&c&oPlayer " + '"' + playerName + '"' + " already has direct access to permission " + '"' + result + '"' + " in world " + '"' + worldName + '"');
                    return true;
                }
            }
            List<String> worlds = Arrays.asList(um.getWorlds());
            ...
            OfflinePlayer player = Bukkit.getOfflinePlayer(um.usernameToUUID(playerName));
            listener.playerGive(player, worldName, perms);
            sendMessage(p, um.prefix + "&d&oYou just gave permissions &f" + perms.toString() + " &d&oto player &f" + '"' + playerName + '"' + " &d&oin world &f" + '"' + worldName + '"');
            return true;
        }
        ...
        if (length == 5) {
            ...
            for (String result : results) {
                if (permList.contains(result)) {
                    sendMessage(p, um.prefix + "&c&oGroup " + '"' + playerName + '"' + " already has direct access to permission " + '"' + result + '"' + " in world " + '"' + worldName + '"');
                    return true;
                }
            }
            List<String> worlds = Arrays.asList(um.getWorlds());
            ...
            OfflinePlayer player = Bukkit.getOfflinePlayer(um.usernameToUUID(playerName));
            listener.playerGive(player, worldName, perms);
            sendMessage(p, um.prefix + "&d&oYou just gave permissions &f" + perms.toString() + " &d&oto group &f" + '"' + playerName + '"' + " &d&oin world &f" + '"' + worldName + '"');
            return true;
        }
